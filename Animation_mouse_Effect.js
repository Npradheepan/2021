...
<body>
  ...
  <img id="first" src="https://res.cloudinary.com/dmlsw10nk/image/upload/v1623011439/1_oya0j3_zszrkx.jpg" style="display:none;">
...
(function initThree() {
  ...
  webgl.texture = webgl.loader.load(
  ...
  Promise.all([
    ...
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011443/1_s9dnsg_dt2vfd.mp4"
    ),
    ...
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011443/2_hqmv8c_f7lu0h.mp4"
    ),
    webgl.loader.load("https://i.ibb.co/DktpY1G/13.jpg"),
    webgl.loader.load("https://i.ibb.co/YhD5x95/14.jpg"),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011446/3_qjkchz_mihjha.mp4"
    ),
    webgl.loader.load("https://i.ibb.co/99kssL1/15.jpg"),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011448/4_nqdsdn_sopmob.mp4"
    ),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011444/5_xhz9of_wasg7q.mp4"
    ),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011437/6_v9cxwu_fvmi1t.mp4"
    ),
    webgl.loader.load("https://i.ibb.co/FX4bL6Z/16.jpg"),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011447/7_otbhqk_rkhpjq.mp4"
    ),
    ...
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011444/8_uqve8h_oz21u5.mp4"
    ),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011442/9_h3zaob_qavbgy.mp4"
    ),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011438/10_nmlwgh_ggowrk.mp4"
    ),
    webgl.loader.load("https://i.ibb.co/Z8jb7zk/21.jpg"),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011444/11_cr2uom_uzx1xm.mp4"
    ),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011441/12q_i8przi_px1irq.mp4"
    ),
    loadAsync(
      "https://res.cloudinary.com/dmlsw10nk/video/upload/v1623011440/13_kpzt8r_vzdguv.mp4"
    )
  ]).then((result) => {
    webgl.texturesArray = result;
    document
      .getElementById("wrapper")
      .addEventListener("click", changeTexture, false);
  });
  ...
  webgl.texturesOptions = [
    ...
    },
    {
      index: 20,
      texture: "video",
      quote: '“it is beautiful to be <span style="color:#fac370">alive</span>”',
      threshold: 100,
      random: 2.0,
      depth: 10.0,
      size: 1.5,
...
function setup() {
  ...
  webgl.firstAnimation1 = gsap.to(webgl.particlesMesh.rotation, 30, {
    z: 2,
    repeat: -1,
    yoyo: true
  });
  webgl.firstAnimation2 = gsap.fromTo(
  ...
  webgl.timeoutClickInfo = window.setTimeout(() => {
    if (webgl.textureIndex == 1)
      gsap.to(document.querySelector(".clickInfo"), 1.5, {
        top: 0,
        ease: "power4.out"
      });
    else return;
...
function initParticles() {
  ...
  webgl.particlesMesh = new THREE.Mesh(
    webgl.geometryParticles,
    materialParticles
  );
}
...
function changeTexture(e) {
  ...
  if (webgl.textureIndex == 1) {
    ...
    gsap.to(
      document.querySelector(".clickInfo"),
      1,
      { top: -80, ease: "power4.out" },
      0
    );
  }
  ...
  if (webgl.textureIndex === webgl.texturesOptions.length)
  ...
  if (opt.a1) {
    webgl.texturaAnimation1 = gsap.fromTo(
      webgl.particlesMesh.material.uniforms.uDepth,
      1,
      { value: -20 },
    ...
    webgl.texturaAnimation2 = gsap.fromTo(
    ...
    webgl.texturaAnimation5 = gsap.fromTo(
      webgl.particlesMesh.rotation,
      5,
      { z: 0.0 },
      { z: THREE.Math.degToRad(360), ease: "bounce.out", delay: 5 }
    );
    webgl.texturaAnimation2 = gsap.fromTo(
      webgl.particlesMesh.position,
      5,
      { z: 0.0 },
    ...
    webgl.texturaAnimation1 = gsap.fromTo(
      ...
      4,
      { value: opt.depth },
      { value: 10, ease: "bounce.out", delay: 2, yoyo: true, repeat: 1 }
    );
    webgl.texturaAnimation2 = gsap.fromTo(
      webgl.particlesMesh.position,
      2,
      { z: 0.0 },
      { z: 60.0, ease: "elastic.in(1, 0.3)" }
    );
  } else if (opt.a8) {
    ...
    webgl.texturaAnimation0 = tl.fromTo(
      webgl.text,
      1,
      { scale: 1 },
      {
    ...
    if (opt.a10) {
      webgl.texturaAnimation1 = gsap.set(
        webgl.particlesMesh.material.uniforms.uTexture,
        {
          value: webgl.loader.load("https://i.ibb.co/0qhkwkd/20cc.jpg"),
          delay: 4
        }
      );
    }
