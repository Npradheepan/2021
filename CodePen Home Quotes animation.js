...
(function initThree() {
  ...
  Promise.all([
    ...
    loadAsync(
      "https://res.cloudinary.com/dbux8pdyi/video/upload/v1617739202/1_s9dnsg_cuuntw.mp4"
    ),
    ...
    loadAsync(
      "https://res.cloudinary.com/dbux8pdyi/video/upload/v1617739204/2_hqmv8c_aw4ohb.mp4"
    ),
    webgl.loader.load("https://i.ibb.co/DktpY1G/13.jpg"),
    webgl.loader.load("https://i.ibb.co/YhD5x95/14.jpg"),
    loadAsync(
      "https://res.cloudinary.com/dbux8pdyi/video/upload/v1617739210/3_qjkchz_kkvc16.mp4"
    ),
    ...
    loadAsync(
      "https://res.cloudinary.com/dbux8pdyi/video/upload/v1617739207/7_otbhqk_xybpl0.mp4"
    ),
    ...
    loadAsync(
      "https://res.cloudinary.com/dbux8pdyi/video/upload/v1617739196/10_nmlwgh_ghicnx.mp4"
    ),
