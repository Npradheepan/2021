  ...
  <svg class="main1" width="100%" height="100%">
    ...
    <g class="m1_stage">
      <g class="m1_cGroup">
        ...
        <circle class="c1_line c1_line4" cx="0" cy="50" r="550" fill="none" stroke-width="2" stroke="url(#grad1)"
          opacity="0.4" />
        <g class="m1Orb orb4b">
      ...
      <g class="m1_cGroup">
        ...
        <circle class="c1_line c1_line3" cx="0" cy="50" r="450" fill="none" stroke-width="2" stroke="url(#grad1)"
          opacity="0.4" />

        <g class="m1Orb orb3c">
          <image xlink:href="https://assets.codepen.io/721952/logoAngular.png" width="40" height="40" />
        </g>

        <g class="m1Orb orb3b">
          <image xlink:href="https://assets.codepen.io/721952/logoReact.png" width="40" height="40" />
        </g>
        <g class="m1Orb orb3">
          <circle cx="20" cy="8" r="24" stroke="#bc7c00" stroke-width="3" fill="#cc971b" />
      ...
      <g class="m1_cGroup">
        ...
        <circle class="c1_line c1_line2" cx="0" cy="50" r="360" fill="none" stroke-width="2" stroke="url(#grad1)"
          opacity="0.5" />

        <g class="m1Orb orb2">
          <circle cx="18.5" cy="7" r="24.5" fill="#983334" stroke-width="2.5" stroke="#b9393a" />
          <path fill="#fff" opacity="0.7"
      ...
      <g class="m1_cGroup">
        ...
        <circle class="m1OrbBlank" cx="0" cy="50" r="40" fill="rgba(125,200,32,0.19)" />

        <circle class="c1_solid" cx="0" cy="50" r="280" fill="url(#grad1)" opacity="0.2" />
        <circle class="c1_line c1_line1" cx="0" cy="50" r="279" fill="none" stroke-width="3" stroke="url(#grad1)"
          opacity="0.5" />
        <g class="m1Orb orb1">
      ...
      <g class="m1_cGroup">
        <circle class="c1_solid" cx="0" cy="50" r="220" fill="url(#grad1)" opacity="0.4" />
      </g>
      <g class="m1_cGroup">
        <circle class="c1_solid" cx="0" cy="50" r="150" fill="url(#grad1)" opacity="0.5" />
      </g>
      <g class="m1_cGroup">
        <circle class="c1_solid" cx="0" cy="50" r="80" fill="#9e0" opacity="0.6" />
      </g>
    </g>
  </svg>
</body>
